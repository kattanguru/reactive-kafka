package com.nisum.reactive.kafka.config;
...
public class ReactiveKafkaConsumerConfig {
    @Bean
    public ReceiverOptions<String, String> kafkaReceiverOptions(@Value(value = "${CUSTOMER_TOPIC}") String topic, KafkaProperties kafkaProperties) {
